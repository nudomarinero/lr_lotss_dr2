...
template_url = "https://portal.nersc.gov/project/cosmo/data/legacysurvey/dr8/north/sweep/8.0/{}"
...
with open(os.path.join(BASEPATH, "download_legacy_sweeps_north-13h.sh"), 
          "w") as out:
    out.write("#!/bin/bash\n")
